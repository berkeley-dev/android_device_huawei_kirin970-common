...
public final class RilConstS32 {
    ...
    public static final int RIL_REQUEST_CANCEL_IMS_VIDEO_CALL = 346;
    ...
    public static final int RIL_REQUEST_HW_ACTIVE_NCFG_BIN = 354;
    ...
    public static final int RIL_REQUEST_HW_EXCHANGE_MODEM_INFO = 343;
    ...
    public static final int RIL_REQUEST_HW_GET_CSGIDSRCH_INFO = 352;
    ...
    public static final int RIL_REQUEST_HW_GET_IMS_SMS_CONFIG = 351;
    public static final int RIL_REQUEST_HW_GET_IMS_SWITCH = 292;
    public static final int RIL_REQUEST_HW_GET_ISMCOEX = 244;
    public static final int RIL_REQUEST_HW_GET_LAA_STATE = 338;
    ...
    public static final int RIL_REQUEST_HW_GET_RCS_SWITCH_STATE = 340;
    ...
    public static final int RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN = 347;
    ...
    public static final int RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH = 349;
    public static final int RIL_REQUEST_HW_SET_DATA_SUBSCRIPTION = 145;
    public static final int RIL_REQUEST_HW_SET_DATA_SWITCH = 348;
    public static final int RIL_REQUEST_HW_SET_DM_RCS_CFG = 341;
    ...
    public static final int RIL_REQUEST_HW_SET_IMS_SMS_CONFIG = 350;
    ...
    public static final int RIL_REQUEST_HW_SET_RCS_SWITCH = 339;
    public static final int RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL = 353;
    ...
    public static final int RIL_REQUEST_HW_VOLTE_DOMAIN = 345;
    public static final int RIL_REQUEST_HW_VOLTE_IMPI = 344;
    ...
    public static final String toString(int o) {
        ...
        if (o == RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE) {
        ...
        if (o == RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE) == RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE) {
            list.add("RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE");
            flipped |= RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE;
        }
        ...
        if ((o & RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN) == RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN) {
            list.add("RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN");
            flipped |= RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_WITH_IMS_DOMAIN;
        }
        if ((o & RIL_REQUEST_HW_SET_DATA_SWITCH) == RIL_REQUEST_HW_SET_DATA_SWITCH) {
            list.add("RIL_REQUEST_HW_SET_DATA_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_DATA_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH) == RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH) {
            list.add("RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_SET_IMS_SMS_CONFIG) == RIL_REQUEST_HW_SET_IMS_SMS_CONFIG) {
            list.add("RIL_REQUEST_HW_SET_IMS_SMS_CONFIG");
            flipped |= RIL_REQUEST_HW_SET_IMS_SMS_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_GET_IMS_SMS_CONFIG) == RIL_REQUEST_HW_GET_IMS_SMS_CONFIG) {
            list.add("RIL_REQUEST_HW_GET_IMS_SMS_CONFIG");
            flipped |= RIL_REQUEST_HW_GET_IMS_SMS_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_GET_CSGIDSRCH_INFO) == RIL_REQUEST_HW_GET_CSGIDSRCH_INFO) {
            list.add("RIL_REQUEST_HW_GET_CSGIDSRCH_INFO");
            flipped |= RIL_REQUEST_HW_GET_CSGIDSRCH_INFO;
        }
        if ((o & RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL) == RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL) {
            list.add("RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL");
            flipped |= RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL;
        }
        if ((o & RIL_REQUEST_HW_ACTIVE_NCFG_BIN) == RIL_REQUEST_HW_ACTIVE_NCFG_BIN) {
            list.add("RIL_REQUEST_HW_ACTIVE_NCFG_BIN");
            flipped |= RIL_REQUEST_HW_ACTIVE_NCFG_BIN;
        }
        if ((o & RIL_UNSOL_HW_ICCID_CHANGED_IND) == RIL_UNSOL_HW_ICCID_CHANGED_IND) {
            list.add("RIL_UNSOL_HW_ICCID_CHANGED_IND");
            flipped |= RIL_UNSOL_HW_ICCID_CHANGED_IND;
        }
        if ((o & RIL_UNSOL_HW_IMS_REG_TYPE_IND) == RIL_UNSOL_HW_IMS_REG_TYPE_IND) {
            list.add("RIL_UNSOL_HW_IMS_REG_TYPE_IND");
            flipped |= RIL_UNSOL_HW_IMS_REG_TYPE_IND;
        }
        if ((o & RIL_UNSOL_HW_SYS_INFO_IND) == RIL_UNSOL_HW_SYS_INFO_IND) {
            list.add("RIL_UNSOL_HW_SYS_INFO_IND");
            flipped |= RIL_UNSOL_HW_SYS_INFO_IND;
        }
        if ((o & RIL_UNSOL_HW_HPLMN_IND) == RIL_UNSOL_HW_HPLMN_IND) {
            list.add("RIL_UNSOL_HW_HPLMN_IND");
            flipped |= RIL_UNSOL_HW_HPLMN_IND;
        }
        if (o != flipped) {
